...
def MC(iterations,discount,N_zero):
        ...
        while stop == False:
            if t == False:
                ...
                for x in range(length-1):
                    ...
                    #calculate the value of varying alfa and ensure that it's not 0
                    if (value_array[c][chosen_action+2]) == 0:
                        alfa = 1
                    else:
                        alfa = 1/(value_array[c][chosen_action+2])
