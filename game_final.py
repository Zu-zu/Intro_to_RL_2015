...
def game(s_init):
    action = input("write S to stop getting new cards and H to get more cards  ")
...
def run():
    s_init = [random.randint(1,10),random.randint(1,10)];
    print(s_init);
    game(s_init);
